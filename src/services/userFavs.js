...
// 	fetch(
// 		`https://dev-cl8pjk73.eu.auth0.com/api/v2/users/auth0%7C62a3b5bee83bbf7596cccb60`,
...
export const userFavs = (userId) =>
	fetch(
		`https://dev-cl8pjk73.eu.auth0.com/api/v2/users/auth0%7C${userId}`,
