...
import { fetchMap } from '../services/fetchMap.js';
import { fetchSearched } from '../services/fetchSearched.js';
...
export default {
	...
	actions: {
		...
		async requestSearch({ commit }, searched) {
