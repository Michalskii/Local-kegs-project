<template>
  <v-container class="">
    ...
    <v-btn @click="callApi" class="text-center">PATCH </v-btn>
    <!-- <v-btn @click="fetchUserFavs">fetch user favs</v-btn> -->
    <div class="header">
...
export default {
  ...
  methods: {
    ...
    //     `https://dev-cl8pjk73.eu.auth0.com/api/v2/users/auth0%7C${this.userId}`,
    ...
    //     }
    //   );
    //   this.fetchedUserFavs = await data.user_metadata.favourites;
    //   console.log(data);
    // },
    ...
    async callApi() {
      ...
      const api_url = `https://dev-cl8pjk73.eu.auth0.com/api/v2/users/auth0%7C${this.userId}`;
      ...
      //   method: "patch",
      //   url: `https://dev-cl8pjk73.eu.auth0.com/api/v2/users/auth0%7C${this.userId}`,
